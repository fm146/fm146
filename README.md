...
Here are the programming languages I use most frequently across my projects, including works on both `fm146` and `hintstechnology` repositories:
...
Here are the fields I am most passionate about and active in:
