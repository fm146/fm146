...
## 🚀 About Me
Saya adalah seorang developer yang berfokus pada **sistem tertanam (embedded systems)**, **IoT (Internet of Things)** khususnya menggunakan ESP32, **pemrosesan sinyal audio (I2S)**, dan **web development**. Saya sangat menyukai jembatan penghubung antara perangkat keras (hardware) dan perangkat lunak (software).

- 🛠️ **Sedang Mengerjakan**: Eksperimen audio ESP32, pengujian performa hardware, dan firmware kustom non-blocking.
- ⚡ **Fun Fact**: Saya suka membuat kontrol CLI interaktif untuk perangkat mikrokontroler.
